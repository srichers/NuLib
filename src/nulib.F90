      ...
      do ng=1,number_groups
         ...
         if (number_local_species.eq.3) then
            ...
            if (add_anumu_kernel_bremsstrahlung) then
               ...
               Phi0s(4,ng,1) = (bremsstrahlung_Phi0_Hannestad(nu_energy_x,nuother_energy_x,temperature,n_N,4,1) + &
                    bremsstrahlung_Phi0_Hannestad(nu_energy_x,nuother_energy_x,temperature,n_N,6,1))/2.0d0 !production of Phi_0
               Phi0s(4,ng,2) = (bremsstrahlung_Phi0_Hannestad(nu_energy_x,nuother_energy_x,temperature,n_N,4,2) + &
    ...
    subroutine single_bremsstrahlung_kernel_point_return_all_Kuroda(iin,n_N,temperature, &
      ...
      do ng=1,number_groups
         ...
         if (number_local_species.eq.3) then
            ...
            !already ensure that amu and atau the same
            if (add_anumu_kernel_bremsstrahlung) then
               Phi0s(4,ng,1) = (bremsstrahlung_Phi0_Kuroda(nu_energy_x,nuother_energy_x,temperature,n_N,4,1) + &
                    bremsstrahlung_Phi0_Kuroda(nu_energy_x,nuother_energy_x,temperature,n_N,6,1))/2.0d0 !production of Phi_0
               Phi0s(4,ng,2) = (bremsstrahlung_Phi0_Kuroda(nu_energy_x,nuother_energy_x,temperature,n_N,4,2) + &
